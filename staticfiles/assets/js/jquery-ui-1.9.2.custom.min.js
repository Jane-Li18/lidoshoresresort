...
!(function (t) {
  ...
  ($.cleanData =
    ...
    ($.widget = function (t, i, e) {
      ...
      return (
        e || ((e = i), (i = $.Widget)),
        Array.isArray(e) && (e = $.extend.apply(null, [{}].concat(e))),
        ($.expr.pseudos[l.toLowerCase()] = function (t) {
          return !!$.data(t, l);
        }),
        ($[o] = $[o] || {}),
        (a = $[o][t]),
        ...
        ((n = new i()).options = $.widget.extend({}, n.options)),
        $.each(e, function (e, a) {
          function s() {
        ...
        a
          ? ($.each(a._childConstructors, function (t, e) {
              var i = e.prototype;
              $.widget(i.namespace + "." + i.widgetName, s, e._proto);
            }),
        ...
        for (e in a[s])
          (i = a[s][e]),
            r.call(a[s], e) &&
              void 0 !== i &&
              ($.isPlainObject(i)
                ? (t[e] = $.isPlainObject(t[e])
                    ? $.widget.extend({}, t[e], i)
                    : $.widget.extend({}, i))
                : (t[e] = i));
      return t;
    }),
    ($.widget.bridge = function (n, e) {
        ...
        return (
          t
            ? this.length || "instance" !== i
              ...
              : (s = void 0)
            : (a.length && (i = $.widget.extend.apply(null, [i].concat(a))),
              this.each(function () {
                var t = $.data(this, r);
                t
                  ? (t.option(i || {}), t._init && t._init())
                  : $.data(this, r, new e(i, this));
              })),
          s
        );
      };
    ...
    ($.Widget.prototype = {
      ...
      _createWidget: function (t, e) {
        (e = $(e || this.defaultElement || this)[0]),
          (this.element = $(e)),
          (this.uuid = i++),
          ...
          e !== this &&
            ($.data(e, this.widgetFullName, this),
            this._on(!0, this.element, {
              remove: function (t) {
                t.target === e && this.destroy();
              },
            }),
            (this.document = $(e.style ? e.ownerDocument : e.document || e)),
            (this.window = $(
      ...
      destroy: function () {
        var i = this;
        this._destroy(),
          $.each(this.classesElementLookup, function (t, e) {
            i._removeClass(e, t);
          }),
      ...
      option: function (t, e) {
        ...
        if ("string" == typeof t)
          if (((n = {}), (t = (i = t.split(".")).shift()), i.length)) {
            for (
              a = n[t] = $.widget.extend({}, this.options[t]), s = 0;
              s < i.length - 1;
              s++
            )
              (a[i[s]] = a[i[s]] || {}), (a = a[i[s]]);
              ...
              (i = s.add
                ? (s.element.each(function (t, e) {
                    $.map(r.classesElementLookup, function (t) {
                      ...
                      return t.is(e);
                    }) || r._on($(e), { remove: "_untrackClassesElement" });
                  }),
                  $($.uniqueSort(i.get().concat(s.element.get()))))
                : $(i.not(s.element).get())),
      ...
      _untrackClassesElement: function (i) {
        var a = this;
        $.each(a.classesElementLookup, function (t, e) {
          -1 !== $.inArray(i.target, e) &&
            (a.classesElementLookup[t] = $(e.not(i.target).get()));
        }),
          this._off($(i.target));
      },
      ...
      _on: function (s, n, t) {
        ...
        "boolean" != typeof s && ((t = n), (n = s), (s = !1)),
          t
            ? ((n = r = $(n)), (this.bindings = this.bindings.add(n)))
          ...
          $.each(t, function (t, e) {
            ...
            "string" != typeof e &&
              (i.guid = e.guid = e.guid || i.guid || $.guid++);
            var a = t.match(/^([\w:-]*)\s*(.*)$/),
    ...
    $.each({ show: "fadeIn", hide: "fadeOut" }, function (n, r) {
      $.Widget.prototype["_" + n] = function (e, t, i) {
        var a,
        ...
        "number" == typeof (t = t || {})
          ...
          a && $.effects && $.effects.effect[s]
            ? e[n](t)
            : s !== n && e[s]
            ? e[s](t.duration, t.easing, i)
            : e.queue(function (t) {
                $(this)[n](), i && i.call(e[0]), t();
              });
      };
    });
  var t, l;
  ...
  function h() {
    $.datepicker._isDisabledDatepicker(
      (l.inline ? l.dpDiv.parent() : l.input)[0]
    ) ||
      ($(this)
  ...
  function c(t, e) {
    for (var i in ($.extend(t, e), e)) null == e[i] && (t[i] = e[i]);
    return t;
  }
    ...
    $.extend(e.prototype, {
      ...
      _attachDatepicker: function (t, e) {
        ...
        t.id || ((this.uuid += 1), (t.id = "dp" + this.uuid)),
          ((i = this._newInst($(t), s)).settings = $.extend({}, e || {})),
          "input" === a
      ...
      _attachments: function (t, e) {
        ...
        e.append && e.append.remove(),
          a &&
            ((e.append = $("<span>").addClass(this._appendClass).text(a)),
          ...
          ("button" !== i && "both" !== i) ||
            ...
            this._get(e, "buttonImageOnly")
              ...
              : ((e.trigger = $("<button type='button'>").addClass(
                  this._triggerClass
                )),
                i
                  ? e.trigger.html(
                      $("<img>").attr({ src: i, alt: a, title: a })
                    )
                  : e.trigger.text(a)),
      ...
      _dialogDatepicker: function (t, e, i, a, s) {
        ...
        return (
          r ||
            ...
            $.data(this._dialogInput[0], "datepicker", r)),
          c(r.settings, a || {}),
      ...
      _doKeyDown: function (t) {
        var e,
          i,
          a = $.datepicker._getInst(t.target),
          s = !0,
          n = a.dpDiv.is(".ui-datepicker-rtl");
        if (((a._keyEvent = !0), $.datepicker._datepickerShowing))
          switch (t.keyCode) {
            case 9:
            ...
            case 13:
              return (
                ...
                (e = $.datepicker._get(a, "onSelect"))
                  ? ((i = $.datepicker._formatDate(a)),
            ...
            case 33:
              $.datepicker._adjustDate(
                t.target,
                t.ctrlKey
                  ? -$.datepicker._get(a, "stepBigMonths")
                  : -$.datepicker._get(a, "stepMonths"),
                "M"
              );
              break;
            case 34:
      ...
      _showDatepicker: function (t) {
        ...
        "input" !== (t = t.target || t).nodeName.toLowerCase() &&
          ...
          $.datepicker._isDisabledDatepicker(t) ||
            ...
            !1 !==
              (i = (a = $.datepicker._get(s, "beforeShow"))
                ? a.apply(t, [t, s])
                : {}) &&
              (c(s.settings, i),
              (s.lastVal = null),
              ($.datepicker._lastInput = t),
              $.datepicker._setDateFromField(s),
              ...
              $.datepicker._updateDatepicker(s),
              (a = $.datepicker._checkOffset(s, a, e)),
              s.dpDiv.css({
                position:
              ...
              s.inline ||
                ((i = $.datepicker._get(s, "showAnim")),
                (a = $.datepicker._get(s, "duration")),
                s.dpDiv.css(
                  "z-index",
                  (function (t) {
                ...
                $.effects && $.effects.effect[i]
                  ? s.dpDiv.show(i, $.datepicker._get(s, "showOptions"), a)
                  : s.dpDiv[i || "show"](i ? a : null),
                $.datepicker._shouldFocusInput(s) && s.input.trigger("focus"),
                ($.datepicker._curInst = s))));
      },
      _updateDatepicker: function (t) {
        (this.maxRows = 4),
          (l = t).dpDiv.empty().append(this._generateHTML(t)),
          this._attachHandlers(t);
        var e,
          i = this._getNumberOfMonths(t),
          a = i[1],
          s = t.dpDiv.find("." + this._dayOverClass + " a"),
          n = $.datepicker._get(t, "onUpdateDatepicker");
        0 < s.length && h.apply(s.get(0)),
          t.dpDiv
            .removeClass(
          ...
          t === $.datepicker._curInst &&
            $.datepicker._datepickerShowing &&
            $.datepicker._shouldFocusInput(t) &&
      ...
      _findPos: function (t) {
        for (
          ...
          t &&
          ("hidden" === t.type || 1 !== t.nodeType || $.expr.pseudos.hidden(t));
      ...
      _hideDatepicker: function (t) {
        ...
        !a ||
          ...
          (this._datepickerShowing &&
            ...
            $.effects && ($.effects.effect[e] || $.effects[e])
              ? a.dpDiv.hide(e, $.datepicker._get(a, "showOptions"), i, t)
              : a.dpDiv[
                  "slideDown" === e
                    ? "slideUp"
                    : "fadeIn" === e
      ...
      _selectDay: function (t, e, i, a) {
        var s = $(t);
        $(a).hasClass(this._unselectableClass) ||
          this._isDisabledDatepicker(s[0]) ||
          (((s = this._getInst(s[0])).selectedDay = s.currentDay =
            parseInt($("a", a).attr("data-date"))),
            ...
            if (u)
              ...
              switch (e.charAt(n)) {
                ...
                case "o":
                  ...
                  break;
                case "m":
                  d += a("m", t.getMonth() + 1, 2);
                  break;
                case "M":
                  d += s("M", t.getMonth(), l, h);
                  break;
                case "y":
                  d += c("y")
                    ? t.getFullYear()
              ...
              ? (function (t) {
                  try {
                    return $.datepicker.parseDate(
                      $.datepicker._get(o, "dateFormat"),
                      t,
                      $.datepicker._getFormatConfig(o)
                    );
                  } catch (t) {}
                  for (
                    var e =
                        (t.toLowerCase().match(/^c/)
                          ? $.datepicker._getDate(o)
                          : null) || new Date(),
                      i = e.getFullYear(),
                      a = e.getMonth(),
                      s = e.getDate(),
                    ...
                    switch (r[2] || "d") {
                      ...
                      case "M":
                        (a += parseInt(r[1], 10)),
                          (s = Math.min(s, $.datepicker._getDaysInMonth(i, a)));
                        break;
                      case "y":
                      case "Y":
                        (i += parseInt(r[1], 10)),
      ...
      _generateHTML: function (t) {
        ...
        if ((z < 0 && ((z += 12), B--), q))
          for (
            e = this._daylightSavingAdjust(
              ...
              e = U && e < U ? U : e;
            this._daylightSavingAdjust(new Date(B, z, 1)) > e;
        ...
        for (
          t.drawMonth = z,
            ...
            K = this._get(t, "gotoCurrent") && t.currentDay ? W : E,
            Y = P ? this.formatDate(Y, K, this._getFormatConfig(t)) : Y,
            H = "",
            t.inline ||
              (H = $("<button>")
                .attr({
            ...
            P = "",
            j &&
              (P = $("<div class='ui-datepicker-buttonpane ui-widget-content'>")
                .append(O ? H : "")
                .append(
                  this._isInRange(t, K)
                    ? $("<button>")
          ...
          for (m = "", this.maxRows = 4, v = 0; v < L[1]; v++) {
            if (
              ((y = this._daylightSavingAdjust(new Date(B, z, t.selectedDay))),
              (k = " ui-corner-all"),
              (b = ""),
              R)
            ) {
              if (((b += "<div class='ui-datepicker-group"), 1 < L[1]))
                switch (v) {
                  case 0:
            ...
            for (
              b +=
                ...
                k +
                "'>" +
                (/all|left/.test(k) && 0 === _ ? (O ? a : i) : "") +
                (/all|right/.test(k) && 0 === _ ? (O ? i : a) : "") +
            ...
            for (
              b += D + "</tr></thead><tbody>",
                ...
                C = Math.ceil((M + C) / 7),
                x = R && this.maxRows > C ? this.maxRows : C,
                this.maxRows = x,
              ...
              for (
                ...
                (A = c ? c.apply(t.input ? t.input[0] : null, [I]) : [!0, ""]),
                  (F =
                    ((S = I.getMonth() !== z) && !u) ||
                    !A[0] ||
                    (U && I < U) ||
                  ...
                  (N +=
                    ...
                    (S && !d
                      ...
                      : "<a class='ui-state-default" +
                        ...
                        "' href='#' aria-current='" +
                        (I.getTime() === W.getTime() ? "true" : "false") +
                        "' data-date='" +
                        I.getDate() +
                        "'>" +
                        I.getDate() +
  ...
  $.widget("ui.tabs", {
    ...
    _create: function () {
      ...
      (this.running = !1),
        ...
        Array.isArray(t.disabled) &&
          (t.disabled = $.uniqueSort(
            t.disabled.concat(
              $.map(this.tabs.filter(".ui-state-disabled"), function (t) {
        ...
        null === i &&
          (a &&
            this.tabs.each(function (t, e) {
              if ($(e).attr("aria-controls") === a) return (i = t), !1;
            }),
          (null !==
            (i =
              null === i
    ...
    _tabKeydown: function (t) {
      var e = $($.ui.safeActiveElement(this.document[0])).closest("li"),
        i = this.tabs.index(e),
        a = !0;
    ...
    _panelKeydown: function (t) {
      this._handlePageNav(t) ||
        (t.ctrlKey &&
          t.keyCode === $.ui.keyCode.UP &&
          (t.preventDefault(), this.active.trigger("focus")));
    },
    _handlePageNav: function (t) {
      return t.altKey && t.keyCode === $.ui.keyCode.PAGE_UP
        ? (this._activate(this._focusNextTab(this.options.active - 1, !1)), !0)
        : t.altKey && t.keyCode === $.ui.keyCode.PAGE_DOWN
    ...
    _findNextTab: function (t, e) {
      ...
      for (
        ;
        -1 !==
        $.inArray((t = (t = i < t ? 0 : t) < 0 ? i : t), this.options.disabled);
    ...
    refresh: function () {
      ...
      (t.disabled = $.map(e.filter(".ui-state-disabled"), function (t) {
        ...
        !1 !== t.active && this.anchors.length
          ? this.active.length && !$.contains(this.tablist[0], this.active[0])
            ? this.tabs.length === t.disabled.length
              ? ((t.active = !1), (this.active = $()))
        ...
        this.anchors.each(function (t, e) {
          ...
          l._isLocal(e)
            ? ((s = (i = e.hash).substring(1)),
              (a = l.element.find(l._sanitizeSelector(i))))
            : ((s = r.attr("aria-controls") || $({}).uniqueId()[0].id),
              (a = l.element.find((i = "#" + s))).length ||
                (a = l._createPanel(s)).insertAfter(
                  l.panels[t - 1] || l.tablist
                ),
              a.attr("aria-live", "polite")),
            a.length && (l.panels = l.panels.add(a)),
    ...
    _createPanel: function (t) {
      return $("<div>").attr("id", t).data("ui-tabs-destroy", !0);
    },
    _setOptionDisabled: function (t) {
      var e, i;
      for (
      ...
      "fill" === t
        ? ((i = e.height()),
          ...
          this.panels
            .each(function () {
              $(this).height(
                Math.max(0, i - $(this).innerHeight() + $(this).height())
              );
            })
            .css("overflow", "auto"))
        : "auto" === t &&
          ...
          this.panels
            .each(function () {
              i = Math.max(i, $(this).height("").height());
            })
            .height(i));
    },
    _eventHandler: function (t) {
      var e = this.options,
        i = this.active,
        a = $(t.currentTarget).closest("li"),
        s = a[0] === i[0],
        n = s && e.collapsible,
        r = n ? $() : this._getPanelForTab(a),
        o = i.length ? this._getPanelForTab(i) : $(),
        i = { oldTab: i, oldPanel: o, newTab: n ? $() : a, newPanel: r };
      t.preventDefault(),
    ...
    _getIndex: function (t) {
      return (t =
        "string" == typeof t
          ? this.anchors.index(
              this.anchors.filter("[href$='" + $.escapeSelector(t) + "']")
            )
          : t);
    },
    _destroy: function () {
    ...
    disable: function (t) {
      ...
      if (!0 !== e) {
        if (void 0 === t) e = !0;
          ...
          e = Array.isArray(e) ? $.merge([t], e).sort() : [t];
        }
    ...
    load: function (t, a) {
      ...
      var n = this,
        ...
        o = { tab: i, panel: r };
      this._isLocal(t[0]) ||
        ((this.xhr = $.ajax(this._ajaxSettings(t, a, o))),
        this.xhr &&
          ...
          this.xhr
            .done(function (t, e, i) {
              setTimeout(function () {
                r.html(t), n._trigger("load", a, o), s(i, e);
              }, 1);
            })
            .fail(function (t, e) {
              setTimeout(function () {
      ...
      return {
        ...
        beforeSend: function (t, e) {
          return s._trigger(
            "beforeLoad",
            i,
            $.extend({ jqXHR: t, ajaxSettings: e }, a)
          );
        },
      };
    },
    _getPanelForTab: function (t) {
      t = $(t).attr("aria-controls");
